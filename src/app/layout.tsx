      ...
      <head>
        <Script id="posthog-script" strategy="beforeInteractive">
          {`
            ...
            posthog.init('phc_jtnP4UDWR0taKzYDkjVCMcCmMG0v2qlCxI1JWEDoV4d',{api_host:'https://us.i.posthog.com'});
          `}
        </Script>
      </head>
      <body
      ...
      >
        <ThemeProvider attribute="class" defaultTheme="light">
          <TooltipProvider delayDuration={0}>
            <NoiseTexture className="fixed inset-0 z-0 h-screen w-screen" />
